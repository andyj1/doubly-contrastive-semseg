...
class ACDC_City(data.Dataset):
    ...
    **Parameters:**
    ...
    def __init__(self, root: Path, dataset_name='cityscapes', mode='test', save_filename=False,
        ...
        if self.opts.debug:
            acdc_city_dict = {
                'train': 'filenames/acdc_city/acdc_city_train_small.txt',
                'val': 'filenames/acdc_city/acdc_city_val_small.txt',
                'test': 'filenames/acdc_city/acdc_city_test_small.txt'
            }
        else:
            if self.opts.acdc_cityfull:
                acdc_city_dict = {
                    'train': 'filenames/acdc_city/acdc_cityfull_train.txt',
                    'val': 'filenames/acdc_city/acdc_cityfull_val.txt',
                    'test': 'filenames/acdc_city/acdc_cityfull_test.txt'
                }
            else:
                acdc_city_dict = {
                    'train': 'filenames/acdc_city/acdc_city_train.txt',
                    'val': 'filenames/acdc_city/acdc_city_val.txt',
                    'test': 'filenames/acdc_city/acdc_city_test.txt'
                }
        ...
        self.samples = []
        dataset_dict = {'acdc_city': acdc_city_dict}
        ...
        for line in lines:
            ...
            sample['label'] = gt_label if gt_label is not None else None
